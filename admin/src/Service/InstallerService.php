...
final class InstallerService
{
    ...
    public function removeObsoleteFiles(): void
    {
        $paths = [
            ...
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listone.php',
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listone.xml',
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listtwo.php',
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listtwo.xml',
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listthree.php',
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listthree.xml',
            JPATH_SITE . '/components/com_contentbuilderng/tmpl/list/listfour.php',
