...
(
    ...
    `export_include`           tinyint(1) NOT NULL DEFAULT '1',
...
(
    ...
    `export_id_column`                    tinyint(1)   NOT NULL DEFAULT '1',
    `export_state_column`                 tinyint(1)   NOT NULL DEFAULT '0',
    `export_publish_column`               tinyint(1)   NOT NULL DEFAULT '0',
