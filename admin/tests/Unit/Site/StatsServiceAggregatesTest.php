...
{
    /**
     * @return array<string,array{0:array<int|string,int>,1:array{sum: float|null, min: float|string|null, max: float|string|null, avg: float|null}}>
     */
    public static function aggregatesProvider(): array
    {
        return [
            'empty map' => [
                [],
                ['sum' => null, 'min' => null, 'max' => null, 'avg' => null],
            ],
            'single value' => [
                ['5' => 3],
                ['sum' => 15.0, 'min' => 5.0, 'max' => 5.0, 'avg' => 5.0],
            ],
            'integers weighted by counts' => [
                ['1' => 2, '10' => 1, '4' => 3],
                ['sum' => 24.0, 'min' => 1.0, 'max' => 10.0, 'avg' => 4.0],
            ],
            'decimal and negative values' => [
                ['-2.5' => 2, '0' => 1, '3.25' => 4],
                ['sum' => 8.0, 'min' => -2.5, 'max' => 3.25, 'avg' => 8 / 7],
            ],
            'mixed numeric and text' => [
                ['1' => 2, 'n/a' => 1, '3' => 5],
                ['sum' => null, 'min' => null, 'max' => null, 'avg' => 17 / 7],
            ],
            'text only' => [
                ['yes' => 4, 'no' => 2],
                ['sum' => null, 'min' => null, 'max' => null, 'avg' => null],
            ...
            'dates' => [
                ...
                ['sum' => null, 'min' => '2025-12-01', 'max' => '2026-03-15', 'avg' => null],
            ],
            'datetimes with and without seconds' => [
                ['2026-01-08 09:30' => 1, '2026-01-08 09:15:42' => 2],
                ['sum' => null, 'min' => '2026-01-08 09:15:42', 'max' => '2026-01-08 09:30', 'avg' => null],
            ],
            ...
            'numeric with surrounding sign and exponent' => [
                ['1e2' => 1, '+3' => 2],
                ['sum' => 106.0, 'min' => 3.0, 'max' => 100.0, 'avg' => 106 / 3],
            ],
        ];
    }
     ...
     * @param array{sum: float|null, min: float|string|null, max: float|string|null, avg: float|null} $expected
     */
    ...
    public function testCbstatsScalarOutputsPreserveHistoricalFallbacks(): void
    {
        $payload = [
            ...
            'records' => [],
            'field' => ['sum' => null, 'min' => '2026-01-02', 'max' => '2026-03-04', 'avg' => null],
        ];
