...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        $this->sections = [
            ...
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_REMAINING_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_REMAINING_TEXT'),
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_PERCENTAGE_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_PERCENTAGE_TEXT'),
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_PROGRESS_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_PROGRESS_TEXT'),
            ...
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_EDITORIAL_CARD_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_EDITORIAL_CARD_TEXT'),
            ...
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_TITLESET_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_TITLESET_TEXT'),
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_GROUPSET_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_GROUPSET_TEXT'),
            $this->section('PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_CONFIG_LABEL', 'PLG_CONTENT_CONTENTBUILDERNG_CBSTATS_HELP_CONFIG_TEXT'),
