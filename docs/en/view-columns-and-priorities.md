...
This page explains the **List**, **Search**, **Link**, **Detail**, **API**,
**Edit** and **Publish** columns in a ContentBuilder NG View.
...
1. **Publish in the field table** publishes a field in the View. It determines
   whether List, Search, Link, Detail, API or Edit may use that field.
...
2. **field function**: List, Search, Link, Detail, API or Edit must be enabled;
