...
<div align="center">
<button class="button" onclick="window.print()"><?php echo Text::_('COM_CONTENTBUILDER_PRINT')?></button>
<button class="button" onclick="self.close()"><?php echo Text::_('COM_CONTENTBUILDER_CLOSE')?></button>
</div>
